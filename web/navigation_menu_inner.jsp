    ...
    <body>
      ...
      <script type="text/javascript">
        ...
        $('#tasksBtn').click(function(event) {
            ...
            window.location.href = "/TMT/tmt/tasks";
        });
        ...
        $('#systemsMenuBtn').click(function(event) {
            ...
            window.location.href = "/TMT/tmt/systems";
        }); 
        ...
        $('#dailyReportsMenuBtn').click(function(event) {
            //navigate to  resources
            window.location.href = "/TMT/tmt/reports/daily/report";
        });
        
        $('#monthlyReportsMenuBtn').click(function(event) {
            //navigate to  resources
            window.location.href = "/TMT/tmt/reports/monthly/report";
        });
        
        $('#timesheetsMenuBtn').click(function(event) {
            //navigate to  resources
            window.location.href = "/TMT/tmt/reports/resources/timesheets";
        });
